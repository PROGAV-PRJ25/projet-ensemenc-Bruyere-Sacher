...
// joueur.StockSemis.Add(new Semis("Tomate",5,5));
// joueur.StockSemis.Add(new Semis("Maïs", 5,5));
// joueur.StockSemis.Add(new Semis("Piment",5,5));

// // Créer un terrain avec 3 parcelles
// Terrain terrain1 = new Terrain("Potager principal");
